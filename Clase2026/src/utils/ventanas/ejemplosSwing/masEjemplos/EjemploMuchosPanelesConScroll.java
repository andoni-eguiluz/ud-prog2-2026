package utils.ventanas.ejemplosSwing.masEjemplos;
...
import utils.ventanas.ejemplosSwing.componentesPersonalizados.*;
...
public class EjemploMuchosPanelesConScroll extends JFrame {
	...
	private static class MiPanel extends JPanel {
		public MiPanel( String titulo, String texto ) {
			...
			String grafEjemplo = new String[] { "/tema1c/resueltos/runnerNaves/img/asteroid.png", "/tema1c/resueltos/runnerNaves/img/nave.png", "/tema1c/resueltos/runnerNaves/img/star.png", "/tema1c/resueltos/runnerNaves/img/UD-green.png" } [(new Random()).nextInt(4)];  // Aleatorio para el ejemplo
			JLabelGraficoAjustado graficoEjemplo = new JLabelGraficoAjustado( grafEjemplo, 50, 80 );
